...
function BrandMark({ isScrolled, isLightPage }) {
  return (
    ...
    >
      ...
      <span
        className="text-[7.5px] font-bold uppercase tracking-[0.2em] mr-1 -mt-1 text-[#273266]"
      >
        Clean Technologies
      </span>
    </Link>
...
function NavLink({ item, pathname, mobile = false, isScrolled = false, isLightPage = false }) {
  ...
  const className = classNames(
    ...
    mobile
      ...
      : item.featured
        ? "relative whitespace-nowrap text-base font-normal tracking-wide transition-colors duration-200"
